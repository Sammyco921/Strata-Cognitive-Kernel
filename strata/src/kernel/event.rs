...
impl fmt::Display for EventType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            EventType::CreateNode => write!(f, "CreateNode"),
            EventType::CreateEdge => write!(f, "CreateEdge"),
            EventType::SetProperty => write!(f, "SetProperty"),
            EventType::DeleteNode => write!(f, "DeleteNode"),
            EventType::DeleteEdge => write!(f, "DeleteEdge"),
        }
    }
}
...
/// Canonical on-disk storage format for events.
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
