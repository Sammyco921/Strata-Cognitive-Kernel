...
/// Simulate a third-party developer consuming StrataEngine via the public API.
///
...
fn full_lifecycle_through_strata_engine() {
    ...
    let engine2 = test_engine(replay_events);
...
/// Demonstrate the test_engine() constructor works with no
/// pre-existing files.
#[test]
